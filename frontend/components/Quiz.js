      ...
      {props.quiz ? (
        <>
          ...
          <div id="quizAnswers">
            <div
              className={`answer ${
                props.selectedAnswer === 1 ? "selected" : "answer"
              }`}
            >
              {props.quiz.answers[0].text}
              <button
                label={props.selectedAnswer === 1 ? "SELECTED" : "Select"}
                onClick={() => {
            ...
            <div
              className={`answer ${
                props.selectedAnswer === 2 ? "selected" : "answer"
              }`}
            >
              {props.quiz.answers[1].text}
              <button
                label={props.selectedAnswer === 2 ? "SELECTED" : "Select"}
                onClick={() => {
                  props.selectAnswer(2);
                }}
              >
